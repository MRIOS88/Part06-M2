...
// muy tocado el codigo, asi q ver el review y arreglarlo. en txt esta el extra del DOM.
...
spn.innerHTML = spn.innerHTML + name;
...
function buildToDo(todo, index) {
  ...
  //lo siguiente es de una consigna de más abajo
  toDoText.addEventListener('click', completeToDo);
  //paso8
  return toDoShell;
}
...
function displayToDos() {
  ...
  //paso 3
  var result = buildToDos(toDoItems); //se guarda en var result p/poder hacer el paso4
  //paso 4
...
function addToDo() {
  ...
  var valor = document.getElementById('toDoInput').value;
  //paso 1
  var myTodo = new ToDo(valor);
  //paso 2
